...
/**
 * Defined a custom element Icon for web use.  Icon's SVG data and
 * Name are retrieved from the Lucide icon set (https://lucide.dev),
 * which is licensed under the ISC. See the LICENSE.ISC file for
 * details.
 */
